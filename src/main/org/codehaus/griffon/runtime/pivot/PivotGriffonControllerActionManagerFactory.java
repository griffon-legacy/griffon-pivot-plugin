 ...
 */
public class PivotGriffonControllerActionManagerFactory implements GriffonControllerActionManagerFactory {
    public GriffonControllerActionManager create(GriffonApplication app) {
        return new PivotGriffonControllerActionManager(app);
    }
}
