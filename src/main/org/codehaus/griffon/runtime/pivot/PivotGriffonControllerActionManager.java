 ...
 */
public class PivotGriffonControllerActionManager extends AbstractGriffonControllerActionManager {
    protected PivotGriffonControllerActionManager(GriffonApplication app) {
        super(app);
    }

    @Override
    protected GriffonControllerAction createControllerAction(GriffonController controller, String actionName) {
        return new PivotGriffonControllerAction(controller, actionName);
    }
}
