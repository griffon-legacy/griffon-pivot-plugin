...
public class ComponentTooltipAdapter implements GriffonPivotAdapter, org.apache.pivot.wtk.ComponentTooltipListener {
    private Closure tooltipTriggered;

    public Closure getTooltipTriggered() {
        return this.tooltipTriggered;
    }


    public void setTooltipTriggered(Closure tooltipTriggered) {
        this.tooltipTriggered = tooltipTriggered;
        if (this.tooltipTriggered != null) {
            this.tooltipTriggered.setDelegate(this);
            this.tooltipTriggered.setResolveStrategy(Closure.DELEGATE_FIRST);
        }
    }
