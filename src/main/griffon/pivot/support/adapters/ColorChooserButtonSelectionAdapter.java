...
public class ColorChooserButtonSelectionAdapter implements GriffonPivotAdapter, org.apache.pivot.wtk.ColorChooserButtonSelectionListener {
    private Closure selectedColorChanged;

    public Closure getSelectedColorChanged() {
        return this.selectedColorChanged;
    }


    public void setSelectedColorChanged(Closure selectedColorChanged) {
        this.selectedColorChanged = selectedColorChanged;
        if (this.selectedColorChanged != null) {
            this.selectedColorChanged.setDelegate(this);
            this.selectedColorChanged.setResolveStrategy(Closure.DELEGATE_FIRST);
        }
    }
