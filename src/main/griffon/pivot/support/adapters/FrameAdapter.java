...
public class FrameAdapter implements GriffonPivotAdapter, org.apache.pivot.wtk.FrameListener {
    private Closure menuBarChanged;

    public Closure getMenuBarChanged() {
        return this.menuBarChanged;
    }


    public void setMenuBarChanged(Closure menuBarChanged) {
        this.menuBarChanged = menuBarChanged;
        if (this.menuBarChanged != null) {
            this.menuBarChanged.setDelegate(this);
            this.menuBarChanged.setResolveStrategy(Closure.DELEGATE_FIRST);
        }
    }
